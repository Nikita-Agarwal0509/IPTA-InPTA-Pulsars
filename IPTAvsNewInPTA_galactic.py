...
plt.title("Location of IPTA and NEW InPTA pulsars", y=1.08, fontsize=20)
plt.grid(True)

plt.scatter(l_rad, b_rad, c="grey", s=220, marker="h", alpha=0.7) # IPTA pulsars plotted as gray diamonds
plt.scatter(l1_rad, b1_rad, c="blue",s=180, marker="*",alpha=0.5) # InPTA new pulsars plotted as blue stars
